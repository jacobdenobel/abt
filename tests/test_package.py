...
class TestPackage(unittest.TestCase):
    ...
    def test_wav_to_electrodogram_no_current_steering_no_virtual(self):
        self.evaluate(16, 3.6952946437, current_steering=False, virtual_channels=False)
       
    def test_wav_to_electrodogram_current_steering(self):
        self.evaluate(121, 3.6952946437, current_steering=True, virtual_channels=True)
    ...
    def test_wav_to_electrodogram_not_balanced(self):
        self.evaluate(16, 3.6952946437 / 2, current_steering=True, virtual_channels=False, charge_balanced=False)
        self.evaluate(16, 3.6952946437 / 2, current_steering=False, virtual_channels=False, charge_balanced=False)
        self.evaluate(121, 3.6952946437 / 2, current_steering=True, virtual_channels=True, charge_balanced=False)
        self.evaluate(16, 3.6952946437 / 2, current_steering=False, virtual_channels=True, charge_balanced=False)
